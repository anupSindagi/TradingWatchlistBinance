    ...
    return (
        <div className="realtive flex flex-col w-[80%] mx-auto justify-center items-center pt-4">
            <h1 className="text-center text-4xl text-sky-500 m-4 tracking-widest drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.2)]">trade
                watchlist</h1>
            <div className="hover:underline cursor-pointer text-sky-500 m-1" onClick={(e) => {
                navigate('overview')
            ...
            {
                <ul className="fixed top-48 max-h-[35%] overflow-y-auto bg-white w-[45%] rounded-xl border-2 border-sky-100 m-8">
                    {searchLoading &&
